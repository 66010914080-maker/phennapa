...
<div class="container mt-5 mb-5">
    ...
    <div class="card shadow-lg p-4">
        <div class="card-body">
            ...
            <form method="post" action="f.php">
                ...
                <h3 class="card-title mb-4 border-bottom pb-2 text-primary">ข้อมูลส่วนตัว</h3>
                ...
                <h3 class="card-title mb-4 border-bottom pb-2 text-primary mt-5">ข้อมูลการศึกษาและประสบการณ์</h3>
    ...
    <div class="p-4 bg-light rounded shadow-sm">
        ...
        if (isset($_POST['Submit'])){
            ...
            echo "<strong>ตำแหน่งที่ต้องการสมัคร:</strong> {$job_position}<br>";
            echo "<strong>ชื่อ-สกุล:</strong> {$title} {$fullname}<br>";
            echo "<strong>วันเดือนปีเกิด:</strong> {$birthdate}<br>";
            echo "<strong>ระดับการศึกษาสูงสุด:</strong> {$education}<br><br>";
            echo "<strong>ความสามารถพิเศษ:</strong><br>{$skills}<br><br>";
            echo "<strong>ประสบการณ์ทำงาน:</strong><br>{$experience}";
            echo "</div>";
        } else {
