...
<div class="container mt-5 mb-5">
    ...
    <div class="p-4 bg-light rounded shadow-sm">
        ...
        if (isset($_POST['Submit'])){
			...
			$sql = "INSERT INTO application (a_job_position, a_title, a_fullname, a_birthdate, a_education, a_skills, a_experience) VALUES ('{$job_position}','{$title}','{$fullname}','{$birthdate}','{$education}','{$skills}','{$experience}');";
